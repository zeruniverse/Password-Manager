...
<script type="text/javascript" src="setlocalstorage.js"></script>
    <div class="container theme-showcase">
        ...
        <form>
            ...
            <p <?php if(!$ENABLE_PIN) echo 'style="display:none"';?>>Optional PIN: <input type="text" name="upin" id="upin" value="<?php if(!$ENABLE_PIN) echo $DEFAULT_PIN;?>" /><a href="javascript: showpinhint();">What's this?</a><br /></p>
