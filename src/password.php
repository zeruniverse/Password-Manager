   ...
   <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        ...
        <div class="navbar-header pull-right">
          <div class="pull-left">
              <a href="#" id="navBtnLogout" class="btn btn-info navbar-btn">
                  <i class="glyphicon glyphicon-log-out"></i>
                  <strong class="hidden-xs">Log Out</strong>
              </a>
              <a href="#" id="navBtnUntrust" class="btn btn-danger navbar-btn" title="Delete all cookies">
                  <i class="glyphicon glyphicon-fire"></i>
                  <strong class="hidden-xs">Untrust</strong>
              </a>
          </div>
...
<div class="modal" tabindex="-1" role="dialog" id="backuppw">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post">
                <p id="fileincludeckbp" class="collapse">
                    <input type="checkbox" id="fileincludeckb" />Include Files<br />
                </p>
                <p>
                    You will need your CURRENT login password to unlock the backup file even if you change login
                    password later. Write your CURRENT login password down or remember to generate a new backup file
                    after each time you change the login password.</p>
                <p class="textred">Generating backup file is time consuming...</p>
                <div class="progress">
                    <div class="progress-bar" role="progressbar" id="backuppwdpb" aria-valuenow="0" aria-valuemin="0"
...
<div class="modal" tabindex="-1" role="dialog" id="changefields">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post">
            <p>
                Please edit the fields string according to the default one shown below. It should be JSON format.
                Usually, you don't need to edit this.
            </p>
            <p>
                A field entry should be like:
                <span class="textbold">&quot;<span class="textred">label</span>&quot;:{&quot;colname&quot;:
                &quot;<span class="textred">screen name</span>&quot;,&quot;hint&quot;:
                &quot;<span class="textred">input hint</span>&quot;,&quot;cls&quot;:
                &quot;<span class="textred">style</span>&quot;}</span>,
            ...
            <p>
                ...
                show up in user screen. <span class="textred">screen name</span> is the name for this entry that the
                user see on their screen, need not to be unique. <span class="textred">input hint</span> is the hint
                string that will show up when you try to edit values for this field. <span class="textred">style</span>
                is the display style for this field. If <span class="textred">style</span> string is empty, this field
                will always show up. If <span class="textred">style = hidden</span>, this field will not show up in main
                ...
                <span class="textred">style</span>. There should always be a space before
                <span class="textred">style</span> string, don't delete it.
            </p>
            ...
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input class="form-control passwordText" id="edititeminputpw" type="password"
                            autocomplete="off" placeholder="Leave blank to generate a random password" />
                        <span class="input-group-btn">
                            <button id="editPasswordInput" class="btn btn-warning" type="button"
                                title="Generate random password"><i class="glyphicon glyphicon-refresh"></i></button>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <label class="small blocklabel">
                            PIN can be set on your trusted devices to give you convenience while login. If you set PIN,
                            you can use PIN instead of username and password to login next time. PIN is safe, you only
                            have 3 chances to input a PIN before it's disabled automatically.
                        </label>
                    </div>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post">
                    <div class="form-group">
                        <label for="uploadf" class="control-label">
                            You can upload one attachment for <span id="uploadfitemlab1" class="textbold"></span>.
                        </label>
                        <input type="file" id="uploadf" />
                        <label class="small textred blocklabel">
                            Warning: If you already have an attachment for
                            <span id="uploadfitemlab2" class="textbold"></span>, the old attachment will be overwritten.
                            Maximal file size allowed is 3MB.
                        </label>
                    </div>
                </form>
            </div>
