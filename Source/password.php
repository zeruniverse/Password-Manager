...
<div style="padding:50px;">
	...
	<div class="line"></div>
	<div>Input secret key：<form><input id="secretkey" type="password" /><input type="button" id="keybtn" onClick="showtable();" value="OK"/>&nbsp;|&nbsp;<input class="btn btn-sm btn-default" type="button" onClick="window.location.href='backup.php'" value="BackupData"/>&nbsp;|&nbsp;<input type="button" onClick="quitpwd('');" value="logout"/><input type="button" onClick="quitpwd('<?php echo $usr;?>');" value="Logout and forget this device"/></div>
    <div class="line"></div>
